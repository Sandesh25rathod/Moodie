  ...
  return (
    <>
      ...
      <div className="p-5 w-85">
        ...
        {/* song squares */}
        <h2 className="mt-5 mb-3" style={{ textShadow: '5px 5px 10px rgba(0, 0, 0, 0.5)' }}>
  Hi <span className="text-primary" id="username" style={{ textShadow: '5px 5px 10px rgba(0, 0, 0, 0.5)' }}>{username}</span>, listen to {mood} songs
</h2>
        ...
        {/* webcam and list */}
        <h2 className="mt-5" style={{ textShadow: '4px 4px 5px rgba(0, 0, 0, 0.5)' }}>
